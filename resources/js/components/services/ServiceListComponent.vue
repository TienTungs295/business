                ...
                <div class="col-lg-8 order-lg-2 mt-0 ">
                    <div class="row">
                        ...
                        >
                            <div class="d-flex align-items-start">
                                <img class="flex-0-0-auto" width="60" height="60"
                                     src="/assets/img/business-image/services/house-plant.svg" alt=""
                                />
                                <div class="ps-4">
                                    <h3 class="text-color-dark font-weight-bold text-transform-none text-5 mb-2">
                        ...
                        >
                            <div class="d-flex align-items-start">
                                <img class="flex-0-0-auto" width="70" height="70"
                                     src="/assets/img/business-image/services/pencil-ruler.svg" alt=""
                                />
                                <div class="ps-3">
                        ...
                        >
                            <div class="d-flex align-items-start">
                                <img class="flex-0-0-auto" width="60" height="60"
                                     src="/assets/img/business-image/services/icon-plumbing.svg" alt=""
                                />
                                <div class="ps-4">
                                    <h3 class="text-color-dark font-weight-bold text-transform-none text-5 mb-2">
                        ...
                        >
                            <div class="d-flex align-items-start">
                                <img class="flex-0-0-auto" width="60" height="60"
                                     src="/assets/img/business-image/services/indent-firstline.svg" alt=""
                                />
                                <div class="ps-4">
                                    <h3 class="text-color-dark font-weight-bold text-transform-none text-5 mb-2">
                        ...
                        >
                            <div class="d-flex align-items-start">
                                <img class="flex-0-0-auto" width="60" height="60"
                                     src="/assets/img/business-image/services/share.svg" alt=""
                                />
                                <div class="ps-4">
                                    <h3 class="text-color-dark font-weight-bold text-transform-none text-5 mb-2">
                        ...
                        >
                            <div class="d-flex align-items-start">
                                <img class="flex-0-0-auto" width="60" height="60"
                                     src="/assets/img/business-image/services/todolist-pen.svg" alt=""
                                />
                                <div class="ps-4">
                                    <h3 class="text-color-dark font-weight-bold text-transform-none text-5 mb-2">
                                        Quản lý dự án</h3>
                        ...
                        >
                            <div class="d-flex align-items-start">
                                <img class="flex-0-0-auto" width="60" height="60"
                                     src="/assets/img/business-image/services/magnifier.svg" alt=""
                                />
                                <div class="ps-4">
                                    <h3 class="text-color-dark font-weight-bold text-transform-none text-5 mb-2">
                        ...
                        >
                            <div class="d-flex align-items-start">
                                <img class="flex-0-0-auto" width="60" height="60"
                                     src="/assets/img/business-image/services/square-check.svg" alt=""
                                />
                                <div class="ps-4">
                                    <h3 class="text-color-dark font-weight-bold text-transform-none text-5 mb-2">
