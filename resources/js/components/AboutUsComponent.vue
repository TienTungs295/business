                ...
                <div class="row justify-content-end pt-1 mt-lg-5">
                    <div class="col-7 col-md-5 position-relative">
                        <ul class="breadcrumb d-block ps-2 text-color-light">
                            ...
                            <li class="active fz-12-i before-o-1"> {{$t('message.about_us')}}</li>
                        </ul>
                        <h1 class="position-absolute top-100 left-0 text-color-light font-weight-bold text-6 line-height-3 text-end mt-5-5">
                            <span class="d-block position-relative z-index-1 pb-5 ps-lg-3"> {{$t('message.about_us')}}</span>
            ...
            <div class="row gy-5 gy-lg-0">
                <div class="col-lg-8 order-lg-2 mt-0 ">
                    <div id="who-we-are" class="row">
                        <div class="col">
                            <h2 class="text-color-dark font-weight-bold text-7 line-height-1 mb-4">{{$t('message.who_we_are')}}</h2>
                            ...
                            <div>
                                <p class="fz-16">
                                    {{$t('message.about_us_content1')}}
                                </p>
                                <p class="fz-16">
                                    {{$t('message.about_us_content2')}}
                                </p>
                                <p class="fz-16">
                                    {{$t('message.about_us_content3')}}
                                </p>
                                <p class="fz-16">
                                    {{$t('message.about_us_content4')}}
                                </p>
                            </div>
                            <div class="text-center">
                                <div class="text-start ps-3 ms-1 text-center"><strong
                                    class="text-4-5 negative-ls-1 text-111">MR.NGÔ TRÍ LÊ MINH</strong>
                                    <p class="text-color-default mb-0">{{$t('message.general_manager')}}</p></div>
                            </div>
                        </div>
                    </div>
                </div>
