...
<head>
    ...
    <!-- Style CSS -->
    <link rel="stylesheet" href="{{ asset('css/app.css?version=24') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/responsive.css') }}">
</head>
<body>
<div id="app">
</div>
<script src="{{ asset('js/app.js?version=24') }}"></script>
<!-- Latest jQuery -->
...
{{--</script>--}}
{{--<script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v15.0&appId=464740230892842&autoLogAppEvents=1" nonce="XosqHr5Y"></script>--}}
</body>
</html>
