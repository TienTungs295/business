@foreach($project_categories as $item)
    @if($item["parent_id"] == $parent_id)
        <tr>
            ...
            <th>
                <img src="{!! url('uploads/images/'.$item["image"]) !!}" alt="{!! $item["image"] !!}" width="70" height="70">
            </th>
            <td>
                @if($prefix == "")
        ...
        @include('backend.project-category.tree',['project_categories' => $project_categories,'parent_id' => $item["id"],'prefix'=> $prefix." --|"])
    @endif
@endforeach
