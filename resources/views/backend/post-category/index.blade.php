                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="text-end">
                                <a href="{!! route('createPostCategoryView') !!}" class="btn btn-primary btn-sm"><i
                                        class="bi bi-plus-lg me-1"></i> Thêm
                                    mới
                                </a>
                                <a href="{!! route('postCategoryView') !!}" class="btn btn-primary btn-sm"><i
                                ...
                                @if(!$post_categories->isEmpty())
                                    @foreach($post_categories as $data)
                                        <tr class="align-middle">
                                            ...
                                            <td class="text-center">
                                                <a href="{!! route('updatePostCategoryView',['id' => $data->id]) !!}"
                                                   class="btn btn-info btn-sm text-white">
                                                    <i class="bi bi-pencil-square"></i>
                                                </a>
                                                <form
                                                    action="{!! route('deletePostCategory',['id' => $data->id]) !!}"
