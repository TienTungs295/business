                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="text-end">
                                @if(app()->getLocale() == "vi")
                                    <a href="{!! route('createSliderView') !!}" class="btn btn-primary btn-sm"><i
                                            class="bi bi-plus-lg me-1"></i> Thêm
                                        mới
                                    </a>
                                @endif
                                <a href="{!! route('sliderView') !!}" class="btn btn-primary btn-sm"><i
                                ...
                                @if(!$sliders->isEmpty())
                                    @foreach($sliders as $data)
                                        <tr class="align-middle">
                                            ...
                                            <td class="text-center">
                                                <a href="{!! route('updateSliderView',['id' => $data->id]) !!}"
                                                   class="btn btn-info btn-sm text-white">
                                                    <i class="bi bi-pencil-square"></i>
                                                </a>
                                                <form
                                                    action="{!! route('deleteSlider',['id' => $data->id]) !!}"
