                            ...
                            <form method="POST"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select" name="category_id">
                                            ...
                                            @include('backend.project-category.tree_select',['project_categories' => $project_categories,'selected_id' => isset($project->id) ? $project->category_id: '','parent_id' => 0,'prefix'=> ""])
                                        </select>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text"
                                               value="{!! old('sku', isset($project->sku) ? $project->sku : '')!!}"
                                               class="form-control" name="sku" maxlength="255">
                                    </div>
                                    <div class="col-md-3 d-flex-align-end">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input"
                                                   value="{!! old('is_featured', isset($project->is_featured) ? $project->is_featured : '')!!}"
                                                   name="is_featured"
                                                   {!! old('is_featured', isset($project->is_featured) && $project->is_featured == 1 ? 'checked' : '')!!} type="checkbox">
                                    ...
                                    <div class="col-md-3 d-flex-align-end">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input"
                                                   value="{!! old('is_trending', isset($project->is_trending) ? $project->is_trending : '')!!}"
                                                   name="is_trending"
                                                   {!! old('is_trending', isset($project->is_trending) && $project->is_trending == 1 ? 'checked' : '')!!} type="checkbox">
                                    ...
                                    <div class="col-md-2 d-inline-flex-align-end">
                                        <div class="form-check">
                                            <input class="form-check-input" id="is-contact" type="checkbox"
                                                   value="{!! old('is_contact', isset($project->is_contact) ? $project->is_contact : 0)!!}"
                                                   {!! old('is_contact', isset($project->is_contact) && $project->is_contact == 1 ? 'checked' : '')!!}
                                                   name="is_contact">
                                ...
                                <div class="row mb-3" id="price-block">
                                    <div class="col-md-4">
                                        ...
                                        <input type="number"
                                               value="{!! old('price', isset($project->price) ? $project->price : '')!!}"
                                               class="form-control" name="price">
                                    </div>
                                    <div class="col-md-4">
                                        <label class="form-label">Giá sale</label>
                                        <input type="number"
                                               value="{!! old('sale_price', isset($project->sale_price) ? $project->sale_price : '')!!}"
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <div class="input-group">
                                            <input type="text" readonly id="start-date"
                                                   value="{!! old('start_date', isset($project->start_date) ? date('d-m-Y H:i:s', strtotime($project->start_date)): '')!!}"
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <div class="input-group">
                                            <input type="text" readonly id="end-date"
                                                   value="{!! old('end_date', isset($project->end_date) ? date('d-m-Y H:i:s', strtotime($project->end_date)) : '')!!}"
                                                   class="form-control" style="background: #fff"
                                                   name="end_date"/>
                                            <span class="input-group-text"><i
                                                    class="bi bi-calendar2-week"></i></span>
                                    ...
                                    <div class="col-md-2 d-inline-flex-align-end dis-none" id="is-flash-sale-block">
                                        <div class="form-check">
                                            <input class="form-check-input" id="is-flash-sale" type="checkbox"
                                                   value="{!! old('is_flash_sale', isset($project->is_flash_sale) ? $project->is_flash_sale : '')!!}"
                                                   {!! old('is_flash_sale', isset($project->is_flash_sale) && $project->is_flash_sale == 1 ? 'checked' : '')!!}
                                                   name="is_flash_sale">
                                            <label class="form-check-label">
                                                Flash Sale ?
                                            </label>
                                ...
                                <div class="row mb-3" id="wrap-qty-block">
                                    <div class="col-md-4 d-inline-flex-align-end">
                                        <div class="form-check">
                                            <input class="form-check-input" id="with-storehouse-management"
                                                   type="checkbox"
                                                   value="{!! old('with_storehouse_management', isset($project->with_storehouse_management) ? $project->with_storehouse_management : '')!!}"
                                                   {!! old('with_storehouse_management', isset($project->with_storehouse_management) && $project->with_storehouse_management == 1 ? 'checked' : '')!!}
                                    ...
                                    <div class="col-md-4">
                                        <div id="quantity-block">
                                            ...
                                            <input type="number"
                                                   value="{!! old('quantity', isset($project->quantity) ? $project->quantity : '')!!}"
                                    ...
                                    <div class="col-md-4 d-inline-flex-align-end">
                                        <div class="form-check" id="allow-checkout-when-out-of-stock-block">
                                            <input class="form-check-input"
                                                   type="checkbox"
                                                   value="{!! old('allow_checkout_when_out_of_stock', isset($project->allow_checkout_when_out_of_stock) ? $project->allow_checkout_when_out_of_stock : '')!!}"
                                                   {!! old('allow_checkout_when_out_of_stock', isset($project->allow_checkout_when_out_of_stock) && $project->allow_checkout_when_out_of_stock == 1 ? 'checked' : '')!!}
                                ...
                                <div class="row mb-3" id="stock-status-block">
                                    <div class="col">
                                        ...
                                        <select class="form-control" name="stock_status" id="">
                                            <option
                                                value="1" {!! isset($project->id) && $project->stock_status == 1 ? 'selected' : ''!!}>
                                                Còn hàng
                                            </option>
                                            <option
                                                value="0" {!! isset($project->id) && $project->stock_status  == 0 ? 'selected' : ''!!}>
                                                Hết hàng
                                            </option>
                                        </select>
                                    </div>
                                            ...
                                            @foreach($collections as $data)
                                                <div class="form-check d-inline-flex mr-10">
                                                    <input class="form-check-input" type="checkbox"
                                                           value="{!! $data->id !!}"
                                                           name="collections[]"
                                                        {!! isset($project->collection_ids) && in_array($data->id, $project->collection_ids) ? 'checked' : ''!!}>
                                        ...
                                        @if(!empty($labels))
                                            @foreach($labels as $data)
                                                <div class="form-check d-inline-flex mr-10">
                                                    <input class="form-check-input" type="checkbox"
                                                           value="{!! $data->id !!}"
                                                           name="labels[]" {!! isset($project->label_ids) && in_array($data->id, $project->label_ids) ? 'checked' : ''!!}>
                                                    <label class="ml-10 form-check-label">
                                                        {!! $data->name !!}
                                                    </label>
                                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col">
                                        ...
                                        <input class="form-control" id="project-autocomplete">
                                        <input type="hidden" id="related_project_ids" name="related_project_ids"
                                               value="{!! old('related_project_ids', isset($project->related_project_ids) ? $project->related_project_ids : '') !!}">
                                    </div>
                                </div>
                                <div class="row mb-3" id="projects-selected">
                                    @if(isset($project->id) && !$project->related_projects->isEmpty())
                                        @foreach($project->related_projects as $data)
                                            <div class="project-item" id="{!! $data->id !!}">
                                                <div class="alert alert-light border-dark alert-dismissible "
                                                    ...
                                                    <button type="button" class="btn-close remove-project"
    ...
    <script>
        ...
        $("#project-autocomplete").autocomplete({
            source: function (request, response) {
                $.ajax({
                    url: APP_URL + "/rest/project/find-by-name?exclude_id=" + exclude_id + "&name=" + request.term,
                    contentType: "json",
                    method: "GET",
            ...
            select: function (event, ui) {
                ...
                var dom = `<div class="project-item" id="` + ui.item.id + `">
                                <div class="alert alert-light border-dark alert-dismissible " role="alert">
                                        ...
                                        <button type="button" class="btn-close remove-project" btn-id="` + ui.item.id + `"></button>
                                </div>
                           </div>`;

                let project_ids = $("#related_project_ids").val();
                let project_id_array = [];
                if (project_ids != null && project_ids != undefined && project_ids != "") {
                    project_id_array = project_ids.split(",");
                }
                if (!project_id_array.includes("" + ui.item.id)) {
                    project_id_array.push("" + ui.item.id);
                }
                project_ids = project_id_array.toString();
                $("#related_project_ids").val(project_ids);

                $("#projects-selected").append(dom);
                $(this).val("");
                return false;
            }
        });
        ...
        $(document).on('click', '.remove-project', function (event) {
            let project_id = event.target.getAttribute("btn-id");
            $("#" + project_id).remove();
            ...
            if (project_id_array.includes("" + project_id)) {
                let index = project_id_array.indexOf(project_id)
