                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="text-end">
                                <a href="{!! route('createProjectFieldView') !!}" class="btn btn-primary btn-sm"><i
                                        class="bi bi-plus-lg me-1"></i> Thêm
                                    mới
                                </a>
                                <a href="{!! route('projectFieldView') !!}" class="btn btn-primary btn-sm"><i
                                ...
                                @if(!$project_fields->isEmpty())
                                    @foreach($project_fields as $data)
                                        <tr class="align-middle">
                                            ...
                                            <td class="text-center">
                                                <a href="{!! route('updateProjectFieldView',['id' => $data->id]) !!}"
                                                   class="btn btn-info btn-sm text-white">
                                                    <i class="bi bi-pencil-square"></i>
                                                </a>
                                                <form
                                                    action="{!! route('deleteProjectField',['id' => $data->id]) !!}"
